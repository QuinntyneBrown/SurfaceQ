...
| 36 | [`diff` differs → exit 1, unified diff](./36-diff-unified.md) | L2-003 | [x] |
| 37 | [`diff` never writes to disk](./37-diff-no-writes.md) | L2-003 | [x] |
...
| 42 | [Determinism: repeat run byte-identical](./42-determinism-repeat.md) | L2-012 | [x] |
...
| 47 | [Bundle `typescript` npm package](./47-bundle-typescript.md) | L2-014 | [x] |
| 48 | [Cross-platform determinism CI matrix](./48-cross-platform-ci.md) | L2-007, L2-012 | [x] |
| 49 | [Performance benchmark: 50-file cold run](./49-perf-cold.md) | L2-015 | [x] |
| 50 | [Performance benchmark: 200-file warm run & 500-file memory](./50-perf-warm-memory.md) | L2-015 | [x] |
